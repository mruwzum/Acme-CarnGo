...
<form:form action="finder/find.do" modelAttribute="finder">
	...
	<br />
	<acme:textbox path="description" code="finder.description"/>
	<br />
	<acme:textbox path="originAddress" code="finder.originAddress"/>
	<br />
	<acme:textbox path="destinationAddress" code="finder.destinationAddress"/>
	<br />
